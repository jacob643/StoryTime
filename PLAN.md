...
### Epic 3.4: Dev Tools
- [x] **3.4.1** Add `/simulate` command in the frontend prompt box — type `/simulate 85` to start a real game session with split speeds faked around the given CPM ± 20 WPM, for testing adaptive scoring

...
- [x] **3.6.22** Page-load and reset message — change `reset()` from `"Enter a story prompt and click Send."` to `"... and send"` and set `className = 'neutral'`. Affects `frontend/script.js` line 117-118.
